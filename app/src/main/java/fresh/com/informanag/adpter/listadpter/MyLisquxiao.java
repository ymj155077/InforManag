 ...
 * 商家已发货的列表
 */
public class MyLisquxiao extends BaseAdapter {
    ...
    public MyLisquxiao(ArrayList<String> datas, Context context) {
        this.datas.clear();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        myViewHolder.lin_already.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                context.startActivity(new Intent(context, ActQuXiaoDetails.class));
            }
        });
